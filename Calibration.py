class Calibration:
    ...
    def __init__(self, arr_X:list, arr_Y:list, IoU:float, NaC:float, EaM:float = None, ErM:float = None):
        ...
        Args:
            ...
            EaM (float): Metrica 'Error Absoluto Medio'. Un EAM cercano a cero indica una mejor similitud entre las series 
